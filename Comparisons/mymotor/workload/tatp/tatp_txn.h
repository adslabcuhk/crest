...
bool TxGetSubsciberData(TATP* tatp_client,
                        ...
                        coro_yield_t& yield,
                        tx_id_t tx_id,
                        TXN* txn, GetSubscriberTxnParam* param);
...
bool TxGetNewDestination(TATP* tatp_client,
                         ...
                         coro_yield_t& yield,
                         tx_id_t tx_id,
                         TXN* txn, GetNewDestinationTxnParam* param);
...
bool TxGetAccessData(TATP* tatp_client,
                     ...
                     coro_yield_t& yield,
                     tx_id_t tx_id,
                     TXN* txn, GetAccessDataTxnParam* param);
...
bool TxUpdateSubscriberData(TATP* tatp_client,
                            ...
                            coro_yield_t& yield,
                            tx_id_t tx_id,
                            TXN* txn, UpdateSubscriberDataTxnParam* param);
...
bool TxUpdateLocation(TATP* tatp_client,
                      ...
                      coro_yield_t& yield,
                      tx_id_t tx_id,
                      TXN* txn, UpdateLocationTxnParam* param);
...
bool TxInsertCallForwarding(TATP* tatp_client,
                            ...
                            coro_yield_t& yield,
                            tx_id_t tx_id,
                            TXN* txn, InsertCallForwardingTxnParam* param);
