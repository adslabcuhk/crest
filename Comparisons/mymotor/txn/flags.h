...
#define MAX_VALUE_SIZE 72
#define MAX_VCELL_NUM 3

#elif WORKLOAD_MICRO
#define MAX_VALUE_SIZE 232
#define MAX_VCELL_NUM 4
#endif
...
#define MAX_CLIENT_NUM_PER_MN 120
#define BACKUP_NUM 1  // Backup memory node number. **NOT** 0

#define MAX_DB_TABLE_NUM 15 
#define MAX_ATTRIBUTE_NUM_PER_TABLE 20

/*********************** Options **********************/
#define EARLY_ABORT 0
