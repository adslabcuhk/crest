...
#define FREQUENCY_DEPOSIT_CHECKING 20
...
class SmallBank {
 public:
  ...
  std::vector<SmallBankTxType>* txn_run_types;
  ...
  void PopulateAccountsTable(MemStoreReserveParam* mem_store_reserve_param);
