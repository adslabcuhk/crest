...
# TPC-C
# NUM_WAREHOUSE: [120, 100, 80, 60, 40, 20]
tpcc_contention_level = [100, 80, 60, 40, 20]

# SmallBank
# Zipfian: [0.1, 0.5, 0.7, 0.99, 1.11, 1.22]
NUM_ACCOUNTS = 100000
smallbank_contention_level = [0.1, 0.5, 0.7, 0.99, 1.11, 1.22]

# YCSB
# Zipfian: [0.1, 0.5, 0.7, 0.99, 1.11, 1.22]
ycsb_contention_level = [0.1, 0.5, 0.7, 0.99, 1.11, 1.22]
NUM_RECORDS = 1000000
NUM_OPS = 3
